        ...
        <Card>
                ...
                {coursesQuery.data.map((course: any) => (
                  <TableRow key={course.id}>
                    ...
                    <TableCell className="text-right">
                      {generatePaymentLinkMutation.isLoading && selectedCourseId === course.id ? (
                        ...
                        >
                          ...
                          {course.paymentLinkUrl ? "Regenerar Link" : "Gerar Link"}
                        </Button>
                      )}
                      ...
                      {course.paymentLinkUrl && (
                        <Button
                          ...
                          size="sm"
                          className="ml-2"
                          onClick={() => window.open(course.paymentLinkUrl, '_blank')}
                        >
          ...
          <CardFooter className="flex justify-between pt-6">
            <div className="text-sm text-muted-foreground">
              <p>Os links de pagamento permitem que clientes realizem a compra do curso diretamente.</p>
              <p>Você pode gerar novos links a qualquer momento, mas isso invalidará os links anteriores.</p>
            </div>
          </CardFooter>
        </Card>
      </div>
