      ...
      const demoCharges = [
        {
          ...
          billingType: 'PIX',
          invoiceUrl: 'https://api.asaas.com/i/pay_000001113590',
          bankSlipUrl: null,
          invoiceNumber: '10001',
        ...
        },
        {
          ...
          invoiceUrl: 'https://api.asaas.com/i/pay_000001113591',
          bankSlipUrl: null,
          invoiceNumber: '10002',
        ...
        },
        {
          ...
          installmentCount: null,
          billingType: 'BOLETO',
          invoiceUrl: 'https://api.asaas.com/i/pay_000001113592',
          bankSlipUrl: 'https://api.asaas.com/b/pay_000001113592',
          invoiceNumber: '10003',
        ...
        },
        {
          ...
          installmentCount: 6,
          billingType: 'PIX',
          invoiceUrl: 'https://api.asaas.com/i/pay_000001113593',
          bankSlipUrl: null,
          invoiceNumber: '10004',
        ...
        },
        {
          ...
          installmentCount: null,
          billingType: 'CREDIT_CARD',
          invoiceUrl: 'https://api.asaas.com/i/pay_000001113594',
          bankSlipUrl: null,
          invoiceNumber: '10005',
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...
          invoiceUrl: `https://api.asaas.com/i/${mockPaymentId}`,
          bankSlipUrl: `https://api.asaas.com/b/${mockPaymentId}`,
