...
// As rotas abaixo estão comentadas pois estão duplicadas com implementação diferente.
// Mantenha esta linha para referência futura caso precise das funcionalidades abaixo.

/* 
 * Implementação antiga/alternativa para referência:
 *
 ...
 * import { storage } from '../storage';
 * 
 * // Esta implementação alternativa foi substituída pela implementação acima
